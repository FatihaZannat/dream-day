(function() {
    var t, e, n, i, r, o, s, a, u, l, d, h, p, c, f, m, g, $, v, y, b, M, _, E, T, w, x, S, L, D, A, C, F = [].slice;
    ...
    w = function(t, e) {
        ...
        if (null != document.createEvent)
            return (n = document.createEvent("HTMLEvents")).initEvent(e, !0, !0),
            t.dispatchEvent(n)
    }
    ,
    b = function() {
    ...
    E = function(t, e) {
        ...
        e) ? (t *= Math.pow(10, e),
        t += .5,
        (t = Math.floor(t)) / Math.pow(10, e)) : Math.round(t)
    }
    ,
    x = function(t) {
    ...
    (p = function() {
        function t(e) {
            var n, i, r, s, a, u, h, p, c, f, m = this;
            if (this.options = e,
            this.el = this.options.el,
            null != this.el.odometer)
                return this.el.odometer;
            for (i in this.el.odometer = this,
            p = t.options)
                s = p[i],
            ...
            try {
                for (u = 0,
                h = (f = ["innerHTML", "innerText", "textContent"]).length; u < h; u++)
                    r = f[u],
        ...
        t.prototype.cleanValue = function(t) {
            var e;
            return "string" == typeof t && (t = parseFloat(t = (t = (t = t.replace(null != (e = this.format.radix) ? e : ".", "<radix>")).replace(/[.,]/g, "")).replace("<radix>", "."), 10) || 0),
            E(t, this.format.precision)
        }
        ,
        ...
        t.prototype.resetFormat = function() {
            var t, e, i, r, o, s, u, l;
            if ((t = null != (u = this.options.format) ? u : n) || (t = "d"),
            !(i = a.exec(t)))
                throw Error("Odometer: Unparsable digit format");
            return s = (l = i.slice(1, 4))[0],
            o = l[1],
            r = (null != (e = l[2]) ? e.length : void 0) || 0,
            this.format = {
                repeating: s,
                radix: o,
                precision: r
        ...
        t.prototype.update = function(t) {
            ...
            if (e = (t = this.cleanValue(t)) - this.value)
                return M(this.el, "odometer-animating-up odometer-animating-down odometer-animating"),
        ...
        t.prototype.addDigit = function(t, e) {
            ...
            return (i = this.renderDigit()).querySelector(".odometer-value").innerHTML = t,
            this.digits.push(i),
            this.insertDigit(i)
        }
        ,
        ...
        t.prototype.animateCount = function(t) {
            ...
            if (i = +t - this.value)
                ...
                (s = function() {
                    ...
                    return ((u = b() - r) > e && (r = b(),
                    n += l = i * (d = u / a.options.duration),
                    a.render(Math.round(n))),
                    null != _) ? _(s) : setTimeout(s, e)
                }
                )()
        }
        ,
        t.prototype.getDigitCount = function() {
            var t, e, n, i, r, o;
            for (i = 1 <= arguments.length ? F.call(arguments, 0) : [],
            t = r = 0,
            o = i.length; r < o; t = ++r)
                n = i[t],
                i[t] = Math.abs(n);
        ...
        t.prototype.getFractionalDigitCount = function() {
            var t, e, n, i, r, o, s;
            for (r = 1 <= arguments.length ? F.call(arguments, 0) : [],
            e = /^\-?\d*\.(\d*?)0*$/,
            t = o = 0,
            s = r.length; o < s; t = ++o)
                i = r[t],
        ...
        t.prototype.animateSlide = function(t) {
            ...
            if (v = this.value,
            (l = this.getFractionalDigitCount(v, t)) && (t *= Math.pow(10, l),
            v *= Math.pow(10, l)),
            i = t - v) {
                for (this.bindTransitionEnd(),
                o = this.getDigitCount(v, t),
                s = [],
                e = 0,
                p = M = 0; 0 <= o ? M < o : M > o; p = 0 <= o ? ++M : --M) {
                    if (y = x(v / Math.pow(10, o - p - 1)),
                    Math.abs(a = (u = x(t / Math.pow(10, o - p - 1))) - y) > this.MAX_VALUES) {
                        for (h = [],
                        c = a / (this.MAX_VALUES + this.MAX_VALUES * e * r),
                        n = y; a > 0 && n < u || a < 0 && n > u; )
                            h.push(Math.round(n)),
                            n += c;
                        ...
                        h = (function() {
                            A = [];
                            for (var t = y; y <= u ? t <= u : t >= u; y <= u ? t++ : t--)
                                A.push(t);
                            return A
                        }
                        ).apply(this);
                ...
                if (y < 0 && this.addDigit("-"),
                null != (m = this.inside.querySelector(".odometer-radix-mark")) && m.parent.removeChild(m),
                l)
                    return this.addSpacer(this.format.radix, this.digits[l - 1], "odometer-radix-mark")
            }
        }
        ,
        t
    ...
    setTimeout(function() {
        ...
        if (window.odometerOptions) {
            for (t in i = window.odometerOptions,
            r = [],
            i)
                e = i[t],
    ...
    p.init = function() {
        ...
        if (null != document.querySelectorAll) {
            for (n = 0,
            e = document.querySelectorAll(p.options.selector || ".odometer"),
            o = [],
            i = e.length; n < i; n++)
                t = e[n],
    ...
    ,
    (null != (C = document.documentElement) ? C.doScroll : void 0) != null && null != document.createEventObject ? (D = document.onreadystatechange,
    document.onreadystatechange = function() {
        return "complete" === document.readyState && !1 !== p.options.auto && p.init(),
